...
if __name__ == "__main__":
    df = pd.read_csv("C:/Users/Администратор/AppData/Local/Jenkins/.jenkins/workspace/download/lab/df_clear.csv")
    ...
    with open("best_model.txt", "w") as f:
        f.write(path2model)
    print(f"Путь к модели сохранен в best_model.txt: {path2model}")
    print(path2model)
